...
<body>
    <main>
        <div class="parallax-container">
            ...
            <div class="center-align text-parallel">
                <p style="font-size: 65px;" class="bold_text">
                    F<span class="bold_text green-text text-accent-4">öö</span>dys <br>
        ...
        <!-- <div class="divider div_container"></div> -->
        <div class="container">
            <h3 class="center-align bold_text grey-text text-darken-4">Popular orders</h3>
            <div class="row">
        ...
        <div class="container">
            <div class="row">
                <div class="col l5">
                    <p style="font-size: 7em;" class="bold_text">F<span class="bold_text green-text text-accent-4">öö</span>dys</p>
                </div>
                <div class="col l7">
                    <h3 class="left-align bold_text grey-text text-darken-4">Hello and welcome, <?php echo $username; ?>!</h3>
                    ...
                    <div class="left-align index_btn">
                        <a href="dashboard.php" class="white-text btn btn-large waves-effect green accent-4">Learn more</a>
                    </div>
                </div>
            </div>
        </div>
